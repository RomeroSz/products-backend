...
def wizard_start(
    ...
    with connection.cursor() as cur:
        ...
        for idramo_c in ramos_contables:
            ...
            """, [ramos_actuariales[0], idramo_c])  # mapeo simple mínimo (ajústalo si requieres UI)
    ...
    return WizardStartResult(product_id=product_id, version_id=version_id, case_id=case_id, product_case_id=product_case_id)
